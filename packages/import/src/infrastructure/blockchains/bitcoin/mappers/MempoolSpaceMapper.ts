...
export class MempoolSpaceTransactionMapper extends BaseRawDataMapper<MempoolTransaction, NormalizedBitcoinTransaction> {
  ...
  protected mapInternal(
    ...
    const normalized: NormalizedBitcoinTransaction = {
      currency: 'BTC',
      id: rawData.txid,
      inputs,
      outputs,
