...
import type { processTransactionCommand } from '../process-transaction.handler.ts';
...
describe('ProcessTransactionCommand Contract', () => {
  let handler: typeof processTransactionCommand;

  describe('Valid Kraken Trade Processing', () => {
    it('should process Kraken spot trade with fee into separate movements', () => {
    ...
    it('should fail on invalid raw data schema', () => {
  ...
  describe('Valid Ethereum Transfer Processing', () => {
    it('should process ETH transfer with gas into separate movements', () => {
  ...
  describe('Business Rule Validation', () => {
    ...
    it('should reject unsupported venue', () => {
