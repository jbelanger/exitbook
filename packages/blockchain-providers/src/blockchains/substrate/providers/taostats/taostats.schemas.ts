...
export const TaostatsTransactionSchema = z.object({
  ...
  fee: z.string().regex(/^\d+$/, 'Fee must be a numeric string').nullish(),
...
export const TaostatsAccountDataSchema = z.object({
  ...
  balance_free_24hr_ago: z.string().nullish(),
  balance_staked: z.string(),
  balance_staked_24hr_ago: z.string().nullish(),
  balance_staked_alpha_as_tao: z.string(),
  balance_staked_alpha_as_tao_24hr_ago: z.string().nullish(),
  balance_staked_root: z.string(),
  balance_staked_root_24hr_ago: z.string().nullish(),
  balance_total: z.string(),
  balance_total_24hr_ago: z.string().nullish(),
  block_number: z.number(),
  coldkey_swap: z.string().nullish(),
...
export const TaostatsBalanceResponseSchema = z.object({
  data: z.array(TaostatsAccountDataSchema).nullish(),
});
...
export const TaostatsTransactionsResponseSchema = z.object({
  data: z.array(TaostatsTransactionSchema).nullish(),
});
