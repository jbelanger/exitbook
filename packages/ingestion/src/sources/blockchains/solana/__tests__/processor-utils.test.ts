...
import { isZeroDecimal, type Currency } from '@exitbook/foundation';
...
describe('Solana Processor Utils', () => {
  ...
  describe('consolidateSolanaMovements', () => {
    ...
    it('should handle multiple consolidations correctly', () => {
      const movements: SolanaMovement[] = [
        { amount: '100', asset: 'SOL' as Currency },
        { amount: '50', asset: 'USDC' as Currency, decimals: 6 },
        { amount: '25', asset: 'SOL' as Currency },
        { amount: '75', asset: 'USDC' as Currency, decimals: 6 },
        { amount: '10', asset: 'BONK' as Currency, decimals: 5 },
      ];
      const result = consolidateSolanaMovements(movements);
    ...
    it('should handle decimal amounts correctly', () => {
      const movements: SolanaMovement[] = [
        { amount: '0.1', asset: 'SOL' as Currency },
        { amount: '0.2', asset: 'SOL' as Currency },
        { amount: '0.3', asset: 'SOL' as Currency },
      ];
      const result = consolidateSolanaMovements(movements);
      expect(result).toHaveLength(1);
      expect(result[0]?.asset).toBe('SOL');
    ...
    describe('Pattern 1: Staking operations', () => {
      it('should classify staking with only outflows as stake', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          transactionCount: 1,
          inflows: [],
          outflows: [{ amount: '10', asset: 'SOL' as Currency }],
          primary: { amount: '10', asset: 'SOL' as Currency },
        };
      ...
      it('should classify staking with small inflow as reward', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          instructionCount: 2,
          transactionCount: 1,
          inflows: [{ amount: '0.5', asset: 'SOL' as Currency }],
          outflows: [],
          primary: { amount: '0.5', asset: 'SOL' as Currency },
        };
      ...
      it('should classify staking with large inflow as unstake', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          instructionCount: 2,
          transactionCount: 1,
          inflows: [{ amount: '10', asset: 'SOL' as Currency }],
          outflows: [],
          primary: { amount: '10', asset: 'SOL' as Currency },
        };
      ...
      it('should handle complex staking with both inflows and outflows', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          instructionCount: 2,
          transactionCount: 1,
          inflows: [{ amount: '5', asset: 'SOL' as Currency }],
          outflows: [{ amount: '10', asset: 'SOL' as Currency }],
          primary: { amount: '10', asset: 'SOL' as Currency },
        };
    ...
    describe('Pattern 2: Fee-only transactions', () => {
      it('should classify fee-only transactions', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          inflows: [],
          outflows: [],
          primary: { amount: '0', asset: 'SOL' as Currency },
        };
    ...
    describe('Pattern 3: Single-asset swaps', () => {
      it('should classify single-asset swap with different assets', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          instructionCount: 3,
          transactionCount: 1,
          inflows: [{ amount: '1000', asset: 'USDC' as Currency }],
          outflows: [{ amount: '5', asset: 'SOL' as Currency }],
          primary: { amount: '1000', asset: 'USDC' as Currency },
        };
    ...
    describe('Pattern 4: DEX swap detection', () => {
      it('should classify swap when DEX program detected', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          transactionCount: 1,
          inflows: [
            { amount: '1000', asset: 'USDC' as Currency },
            { amount: '0.1', asset: 'SOL' as Currency },
          ],
          outflows: [{ amount: '5', asset: 'SOL' as Currency }],
          primary: { amount: '1000', asset: 'USDC' as Currency },
    ...
    describe('Pattern 6: Deposits', () => {
      it('should classify transactions with only inflows as deposits', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          instructionCount: 1,
          transactionCount: 1,
          inflows: [{ amount: '100', asset: 'USDC' as Currency }],
          outflows: [],
          primary: { amount: '100', asset: 'USDC' as Currency },
        };
    ...
    describe('Pattern 7: Withdrawals', () => {
      it('should classify transactions with only outflows as withdrawals', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          transactionCount: 1,
          inflows: [],
          outflows: [{ amount: '100', asset: 'USDC' as Currency }],
          primary: { amount: '100', asset: 'USDC' as Currency },
        };
    ...
    describe('Pattern 9: Complex multi-asset transactions', () => {
      it('should handle complex transactions with uncertainty note', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          transactionCount: 1,
          inflows: [
            { amount: '100', asset: 'USDC' as Currency },
            { amount: '50', asset: 'USDT' as Currency },
          ],
          outflows: [
            { amount: '5', asset: 'SOL' as Currency },
            { amount: '1000', asset: 'BONK' as Currency },
          ],
          primary: { amount: '100', asset: 'USDC' as Currency },
    ...
    describe('Pattern 10: Batch operations', () => {
      it('should classify batch operations with many instructions', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          inflows: [
            { amount: '100', asset: 'USDC' as Currency },
            { amount: '50', asset: 'SOL' as Currency },
          ],
          outflows: [
            { amount: '100', asset: 'USDC' as Currency },
            { amount: '25', asset: 'SOL' as Currency },
    ...
    describe('Ultimate fallback', () => {
      it('should fallback when no pattern matches', () => {
        const fundFlow: SolanaFundFlow = {
          ...
          outflows: [
            { amount: '75', asset: 'SOL' as Currency },
            { amount: '25', asset: 'BONK' as Currency },
          ],
          primary: { amount: '100', asset: 'USDC' as Currency },
        };
  ...
  describe('analyzeSolanaBalanceChanges', () => {
    ...
    describe('Fee deduction logic (Issue #78)', () => {
      ...
      it('should handle multiple SOL outflows with fee deduction', () => {
        const tx = createTx({
          feeAmount: '10000', // 0.000010 SOL in lamports
          feeCurrency: 'SOL' as Currency,
          accountChanges: [
            {
              account: userAddress,
