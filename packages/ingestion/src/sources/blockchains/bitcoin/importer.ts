...
import type { ImportParams, IImporter, ImportBatchResult } from '../../../shared/types/importers.ts';
...
export class BitcoinTransactionImporter implements IImporter {
  ...
  constructor(
    ...
    this.logger.info(
      `Initialized Bitcoin transaction importer - ProvidersCount: ${this.providerManager.getProviders(this.chainConfig.chainName).length}`
    );
  }
