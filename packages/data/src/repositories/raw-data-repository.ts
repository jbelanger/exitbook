...
export interface IRawDataRepository {
   ...
   */
  loadPendingNearAnchorHashes(accountId: number, limit: number): Promise<Result<string[], Error>>;
   ...
   */
  loadPendingByHashes(accountId: number, hashes: string[]): Promise<Result<RawTransaction[], Error>>;
   ...
   */
  loadPendingNearByReceiptIds(accountId: number, receiptIds: string[]): Promise<Result<RawTransaction[], Error>>;
