...
import { createMoney } from '../../decimal-utils';
import type { Money, TransactionType, UniversalTransaction, TransactionStatus } from '../../types';
...
export class TransactionProcessor {
  ...
  private static extractTransactionId(transaction: CCXTTransaction, exchangeId: string): string {
    return (
      transaction.id || transaction.txid || this.createTransactionHash(transaction, exchangeId)
    );
  }
}
