...
export class ImporterFactory {
  ...
  static async create<T>(
    ...
    if (sourceType === 'blockchain') {
      return await ImporterFactory.createBlockchainImporter<T>(
        providerManager,
        sourceId,
        providerId,
      );
  ...
  private static async createAvalancheImporter<T>(
    ...
    const { AvalancheTransactionImporter } = await import(
      '../../blockchains/avalanche/transaction-importer.js'
    );
  ...
  private static async createBitcoinImporter<T>(
    ...
    // Dynamic import to avoid circular dependencies
    const { BitcoinTransactionImporter } = await import(
      '../../blockchains/bitcoin/transaction-importer.js'
    );
  ...
  private static async createEthereumImporter<T>(
    ...
    // Dynamic import to avoid circular dependencies
    const { EthereumTransactionImporter } = await import(
      '../../blockchains/ethereum/transaction-importer.js'
    );
  ...
  private static async createInjectiveImporter<T>(
    ...
    // Dynamic import to avoid circular dependencies
    const { InjectiveTransactionImporter } = await import(
      '../../blockchains/injective/transaction-importer.js'
    );
  ...
  private static async createPolkadotImporter<T>(
    ...
    // Dynamic import to avoid circular dependencies
    const { PolkadotTransactionImporter } = await import(
      '../../blockchains/polkadot/transaction-importer.js'
    );
  ...
  private static async createSolanaImporter<T>(
    ...
    // Dynamic import to avoid circular dependencies
    const { SolanaTransactionImporter } = await import(
      '../../blockchains/solana/transaction-importer.js'
    );
