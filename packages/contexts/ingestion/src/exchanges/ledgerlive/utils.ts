 ...
 */
export function formatLedgerLiveValidationErrors(
  result: LedgerLiveCsvBatchValidationResult,
): string {
 ...
 */
export function extractAccountsFromValidatedData(
  validatedRows: ValidatedCsvLedgerLiveOperationRow[],
): string[] {
 ...
 */
export function extractCurrenciesFromValidatedData(
  validatedRows: ValidatedCsvLedgerLiveOperationRow[],
): string[] {
