  ...
  describe('calculate', () => {
    it('should successfully calculate cost basis with FIFO method', async () => {
      const transactions: UniversalTransaction[] = [
        // Buy 1 BTC at $30,000
        createTransaction(1, '2023-01-01T00:00:00Z', [{ asset: Currency.create('BTC'), amount: '1', price: '30000' }]),
        // Sell 0.5 BTC at $40,000
        createTransaction(
          2,
          '2023-06-01T00:00:00Z',
          [],
          [{ asset: Currency.create('BTC'), amount: '0.5', price: '40000' }]
        ),
      ];
    ...
    it('should apply Canadian 50% inclusion rate', async () => {
      const transactions: UniversalTransaction[] = [
        createTransaction(1, '2023-01-01T00:00:00Z', [{ asset: Currency.create('ETH'), amount: '10', price: '2000' }]),
        createTransaction(
          2,
          '2023-06-01T00:00:00Z',
          [],
          [{ asset: Currency.create('ETH'), amount: '10', price: '2500' }]
        ),
      ];
    ...
    it('should work with LIFO method', async () => {
      const transactions: UniversalTransaction[] = [
        createTransaction(1, '2023-01-01T00:00:00Z', [{ asset: Currency.create('BTC'), amount: '1', price: '30000' }]),
        createTransaction(2, '2023-03-01T00:00:00Z', [{ asset: Currency.create('BTC'), amount: '1', price: '35000' }]),
        createTransaction(
          3,
          '2023-06-01T00:00:00Z',
          [],
    ...
    it('should handle multiple assets', async () => {
      const transactions: UniversalTransaction[] = [
        createTransaction(1, '2023-01-01T00:00:00Z', [{ asset: Currency.create('BTC'), amount: '1', price: '30000' }]),
        createTransaction(2, '2023-01-01T00:00:00Z', [{ asset: Currency.create('ETH'), amount: '10', price: '2000' }]),
        createTransaction(
          3,
          '2023-06-01T00:00:00Z',
          [],
        ...
        createTransaction(
          ...
          '2023-06-01T00:00:00Z',
          [],
          [{ asset: Currency.create('ETH'), amount: '5', price: '2500' }]
        ),
      ];
    ...
    it('should save tax classifications to lot_disposals (Issue #3 fix)', async () => {
      const transactions: UniversalTransaction[] = [
        ...
        createTransaction(
          ...
          [],
          [{ asset: Currency.create('BTC'), amount: '0.5', price: '45000' }]
        ),
      ];
    ...
    it('should disallow wash sale loss with fee allocation (US)', async () => {
      const transactions: UniversalTransaction[] = [
        ...
        createTransactionWithFee(
          ...
          [{ asset: Currency.create('BTC'), amount: '1', price: '50000' }],
          []
        ),
        ...
        createTransactionWithFee(
          ...
          [],
          [{ asset: Currency.create('BTC'), amount: '1', price: '30000' }],
          {
            asset: Currency.create('USD'),
            amount: '100',
            price: '1',
        ...
        createTransactionWithFee(
          ...
          [{ asset: Currency.create('BTC'), amount: '0.5', price: '32000' }],
          [],
          {
            asset: Currency.create('USD'),
            amount: '50',
    ...
    it('should handle superficial loss with multi-asset fees (Canada)', async () => {
      const transactions: UniversalTransaction[] = [
        ...
        createTransactionWithFee(
          ...
          '2024-01-01T00:00:00Z',
          [
            { asset: Currency.create('BTC'), amount: '1', price: '40000' },
            { asset: Currency.create('ETH'), amount: '10', price: '2000' },
          ],
          [],
          { asset: Currency.create('USD'), amount: '60', price: '1' }
        ),
    ...
    it('should correctly classify long-term gains with complex fee scenarios', async () => {
      const transactions: UniversalTransaction[] = [
        ...
        createTransactionWithFee(
          ...
          [],
          [{ asset: Currency.create('BTC'), amount: '0.5', price: '50000' }],
          {
            asset: Currency.create('USD'),
            amount: '200',
            price: '1',
