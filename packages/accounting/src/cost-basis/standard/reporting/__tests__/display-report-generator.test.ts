  ...
  const mockDisposals: LotDisposal[] = [
    {
      ...
      grossProceeds: new Decimal(25000),
      sellingExpenses: new Decimal(0),
      netProceeds: new Decimal(25000),
    ...
    },
    {
      ...
      grossProceeds: new Decimal(60000),
      sellingExpenses: new Decimal(0),
      netProceeds: new Decimal(60000),
    ...
    },
    {
      ...
      grossProceeds: new Decimal(110000),
      sellingExpenses: new Decimal(0),
      netProceeds: new Decimal(110000),
