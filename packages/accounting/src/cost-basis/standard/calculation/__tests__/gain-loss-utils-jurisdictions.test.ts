          ...
          disposals: [
            {
              ...
              grossProceeds: parseDecimal('20000'),
              sellingExpenses: parseDecimal('0'),
              netProceeds: parseDecimal('20000'),
              costBasisPerUnit: parseDecimal('30000'),
          ...
          disposals: [
            {
              ...
              grossProceeds: parseDecimal('25000'),
              sellingExpenses: parseDecimal('0'),
              netProceeds: parseDecimal('25000'),
              costBasisPerUnit: parseDecimal('2000'),
              totalCostBasis: parseDecimal('20000'),
              gainLoss: parseDecimal('5000'),
              disposalDate: new Date('2023-06-01'),
      ...
      const assetResults: AssetLotMatchResult[] = [
        {
          ...
          disposals: [
            ...
            },
            {
              ...
              grossProceeds: parseDecimal('21000'),
              sellingExpenses: parseDecimal('0'),
              netProceeds: parseDecimal('21000'),
              costBasisPerUnit: parseDecimal('35000'),
          ...
          disposals: [
            {
              ...
              grossProceeds: parseDecimal('40000'),
              sellingExpenses: parseDecimal('0'),
              netProceeds: parseDecimal('40000'),
              costBasisPerUnit: parseDecimal('30000'),
              totalCostBasis: parseDecimal('30000'),
