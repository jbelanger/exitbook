    ...
    it('should find matching transactions', () => {
      ...
      const targets: TransactionCandidate[] = [
        ...
        },
        {
          ...
          asset: Currency.create('ETH'), // Different asset
          amount: parseDecimal('0.99'),
          direction: 'in',
          fromAddress: undefined,
          toAddress: undefined,
      ...
      const transactions = [
        {
          ...
          movements: {
            ...
            outflows: [{ asset: Currency.create('USD'), grossAmount: parseDecimal('50000') }],
          },
        },
      ...
      const transactions = [
        {
          ...
          movements: {
            inflows: [{ asset: Currency.create('BTC'), grossAmount: parseDecimal('0.5') }],
            outflows: [],
          },
        },
      ...
      const transactions = [
        {
          ...
          movements: {
            inflows: [
              ...
              { asset: Currency.create('ETH'), grossAmount: parseDecimal('10.0') },
            ],
            outflows: [{ asset: Currency.create('USD'), grossAmount: parseDecimal('60000') }],
          },
        },
      ] as UniversalTransaction[];
