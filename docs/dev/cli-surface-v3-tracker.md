...
| `blockchains`  | `blockchains view`                                              | likely `blockchains`, `blockchains <selector>`, `blockchains view`, `blockchains view <selector>` once selector is settled                | not yet explicit | `pending` | Good simple follow-on after `accounts`.                                     |
