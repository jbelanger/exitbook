...
| `links`        | `links`, `links list`, `links view <selector>`, `links explore [selector]`, `links run`, `confirm`, `reject` | `links`, `links list`, `links view <selector>`, `links explore [selector]`, plus review/workflow commands                         | stable          | `done`    | Root now serves static lists; legacy browse compatibility aliases have been removed.                              |
