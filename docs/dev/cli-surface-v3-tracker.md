...
| `providers`    | bare static list/detail, `view`, `benchmark`                    | `providers`, `providers <selector>`, `providers view`, `providers view <selector>`, `providers benchmark`      | stable          | `in_progress` | Root browse/detail and selector contract are landed; explorer/detail alignment remains. |
