...
| Balance exclusion / scam balance filtering | `/Users/joel/Dev/exitbook/packages/ingestion/src/features/balance/balance-workflow.ts`                                                                                                                  | Mixed: `isSpam` + `diagnostics`                                     | Partially migrated              | Keep explicit spam flag if still needed, but make the diagnostic/flag contract explicit and remove any lingering “notes” terminology  |
