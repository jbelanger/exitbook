...
| [prompts.ts](/Users/joel/Dev/exitbook/apps/cli/src/features/shared/prompts.ts) `handleCancellation(...)`                                                                    | prompt cancellation helper                                                    | exits immediately from deep helper                                    | convert to typed cancelled outcome                                            |
