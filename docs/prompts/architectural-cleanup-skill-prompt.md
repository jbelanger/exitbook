# Reusable Prompt: High-Level Architectural Cleanup

Use this prompt when you want a deep architecture cleanup pass focused on simple, readable, high-integrity code.
...
Optional add-on instruction:

`Also produce a "first refactor PR plan" with exact files to touch and expected test coverage additions.`
