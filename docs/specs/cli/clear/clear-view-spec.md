...
### With Account Selector Filter

```
Clear data — bitcoin-main · 89 items · raw data: preserved
...
| ----------------- | ------------------------------------------------------------ | ------------------------------------------- | ------------------------------------------- |
| Transactions      | Processed transaction records with movements, fees, metadata | `exitbook transactions explore`             | Run `exitbook reprocess` to reprocess       |
| Transaction links | Transfer link matches between outflows and inflows           | `exitbook links explore`                    | Run `exitbook links run` after reprocessing |
