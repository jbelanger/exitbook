// Command registration for prices fetch subcommand
...
/**
 * Register the prices fetch subcommand.
 */
export function registerPricesFetchCommand(pricesCommand: Command): void {
  pricesCommand
    .command('fetch')
