...
function createMockItems(): TransactionViewItem[] {
  return [
    ...
    },
    {
      ...
      operationGroup: 'staking',
      operationLabel: 'staking/reward',
      operationCategory: 'staking',
      operationType: 'reward',
      debitSummary: undefined,
      creditSummary: '1.25 SOL',
    ...
    },
    {
      ...
      operationGroup: 'trade',
      operationLabel: 'trade/sell',
      operationCategory: 'trade',
      operationType: 'sell',
      debitSummary: '0.25 BTC',
      creditSummary: '24,500 USD',
      feeSummary: '6.25 USD',
      primaryMovementAsset: 'BTC',
