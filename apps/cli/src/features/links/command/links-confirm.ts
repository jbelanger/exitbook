...
Examples:
  ...
  $ exitbook links confirm 123 --profile business
  $ exitbook links confirm 123 --json

Notes:
  - Confirming a proposal may update multiple related link rows in the same suggestion group.
`
    )
