...
import { ValidateTransactionCommand, ValidateTransactionCommandHandler } from './ValidateTransactionCommand';
...
describe('ValidateTransactionCommand Contract', () => {
  let handler: ValidateTransactionCommandHandler;
  ...
  describe('Balance Rule Validation', () => {
    it('should validate FEES_AND_GAS_OUT rule', async () => {
    ...
    it('should validate TRADE_PRINCIPALS_BALANCE rule', async () => {
    ...
    it('should validate TRANSFER_BALANCE rule', async () => {
  ...
  describe('Validation Result Handling', () => {
    it('should return all validation results for passed validation', async () => {
    ...
    it('should fail fast and reject entire transaction on any rule failure', async () => {
  ...
  describe('Mathematical Precision', () => {
    it('should maintain Decimal.js precision in balance calculations', async () => {
    ...
    it('should handle edge case amounts (very small/large)', async () => {
  ...
  describe('Event Production', () => {
    it('should produce TransactionValidatedEvent on success', async () => {
    ...
    it('should produce ValidationFailedEvent on failure', async () => {
