...
import { GetTransactionsBySourceQuery, GetTransactionsBySourceQueryHandler } from './GetTransactionsBySourceQuery';
...
describe('GetTransactionsBySourceQuery Contract', () => {
  let handler: GetTransactionsBySourceQueryHandler;
  ...
  describe('Source Filtering', () => {
    it('should filter transactions by exchange venue', async () => {
    ...
    it('should filter transactions by blockchain chain', async () => {
  ...
  describe('Query Validation', () => {
    it('should validate source parameters', async () => {
    ...
    it('should reject unsupported venues and chains', async () => {
