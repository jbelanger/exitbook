...
import { GetMovementsByPurposeQuery, GetMovementsByPurposeQueryHandler } from './GetMovementsByPurposeQuery';
...
describe('GetMovementsByPurposeQuery Contract', () => {
  let handler: GetMovementsByPurposeQueryHandler;
  ...
  describe('Purpose Filtering', () => {
    it('should filter movements by PRINCIPAL purpose', async () => {
    ...
    it('should filter movements by FEE purpose', async () => {
    ...
    it('should filter movements by GAS purpose', async () => {
  ...
  describe('Result Composition', () => {
    it('should return MovementSummary with all required fields', async () => {
    ...
    it('should include source context from parent transaction', async () => {
    ...
    it('should separate diagnostic metadata correctly', async () => {
  ...
  describe('Query Validation', () => {
    it('should validate purpose parameter', async () => {
    ...
    it('should validate currency filter format', async () => {
  ...
  describe('Financial Reporting Use Cases', () => {
    it('should support fee analysis queries', async () => {
    ...
    it('should support gas cost analysis', async () => {
