...
import { GetClassifiedTransactionQuery, GetClassifiedTransactionQueryHandler } from './GetClassifiedTransactionQuery';
...
describe('GetClassifiedTransactionQuery Contract', () => {
  let handler: GetClassifiedTransactionQueryHandler;
  ...
  describe('Transaction Retrieval', () => {
    it('should retrieve classified transaction by ID', async () => {
  ...
  describe('Data Integrity', () => {
    it('should return complete classification metadata', async () => {
    ...
    it('should preserve diagnostic metadata separation', async () => {
  ...
  describe('Query Validation', () => {
    it('should validate transactionId parameter', async () => {
    ...
    it('should validate requestId for tracing', async () => {
